...
const NOTIFICATIONS = [
  {
    ...
    app: 'Hackathon',
    appIcon: '🎯',
    title: 'Mock Achievement 1: 1st Place — Local Hackathon',
    body: 'Mock Project · A one-line description of what you built',
    time: 'Jan 2025',
    accent: '#fbbf24',
    badge: 'WINNER',
  },
  {
    ...
    app: 'Hackathon',
    appIcon: '🚀',
    title: 'Mock Achievement 2: Speaker — Regional Tech Meetup',
    body: 'A one-line description of the talk you gave',
    time: 'Nov 2024',
    accent: '#34d399',
    badge: 'SPEAKER',
  },
  {
    ...
    app: 'Calendar',
    appIcon: '📅',
    title: 'Reference Achievement: Speaking at LLM Day NYC',
